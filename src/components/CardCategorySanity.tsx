...
const CardCategorySanity = ({ CardData }: any) => {
  return (
    <div className="min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {CardData.map((item: any) => {
          const isNewGiftType = item.giftType.includes("New");
          const giftType = item.giftType.replace("New", "").trim();
          ...
          return isNewGiftType ? (
            ...
            >
              ...
              <div className="relative z-0">
                <img
                  ...
                  src={`https://cdn.sanity.io/images/d1isiif6/production/${item.bgimage.asset._ref.replace('image-', '').replace('-png', '.png').replace('-jpg', '.jpg')}`}
                  alt={item.giftType}
                />
            ...
            <div
              ...
              style={{
                backgroundImage: `url(https://cdn.sanity.io/images/d1isiif6/production/${item.bgimage.asset._ref.replace('image-', '').replace('-png', '.png').replace('-jpg', '.jpg')})`,
              }}
            >
...
export default CardCategorySanity;
