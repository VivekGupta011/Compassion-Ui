...
const CardCategoryHyGraph = ({ CardData }: any) => {
  console.log("CardData Vivek Gupta:::");
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {CardData && CardData.length > 0 ? (
          CardData.map((item: any) => {
            ...
            const giftType = item.giftType?.replace("New", "").trim() || "Unknown Type";
            const bgImageUrl = item.giftBgImage?.url || "default-image-url";
            const giftAmount = item.giftAmount || "N/A";
        ...
        {/* Additional content for e-cards */}
...
export default CardCategoryHyGraph;
