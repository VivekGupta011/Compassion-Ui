...
const CardInfoSanity = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const query = groq`*[_type == 'modal'][0...10]`;
  ...
  console.log("Modal Data vivek:", modalData);
    ...
    <section className="px-0 py-8 pb-20 md:py-12 md:pb-36">
      <div className="flex justify-center">
        <div className="max-w-screen relative min-w-0 flex-grow px-4 md:px-[40px] lg:mx-10 lg:max-w-[1100px] lg:px-0">
          ...
          <div>
            <CardCategorySanity CardData={modalData}/>
          </div>
        </div>
      </div>
    </section>
